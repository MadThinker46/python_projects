...
def build_maze(maze):
    ...
    while (blocks_tagged < total):
        ...
        if (options):
            ...
            #    row =[]
            #    for index2 in range (0,wide):
            #        row.append(maze[index][index2])
            #    print row
            #print "\n"
...
def print_asci_maze(maze):
    ...
    #print "the block is",wide,"blocks wide"
    #print "the block is",deep,"blocks deep"
    #print maze
...
def main():
    print  """\n\nMartin's Maze Builder. Shamlessly stolen
